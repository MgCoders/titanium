...
<?php if ( have_comments() ) : ?>
	...
	<ol class="commentlist">
		<?php
			 ...
			 * to use angle_comment() to format the comments.
			 * If you want to overload this in a child theme then you can
			 * define angle_comment() and that will be used instead.
			 * See angle_comment() in functions/theme/functions.php for more.
			 */
			wp_list_comments( array( 'callback' => 'angle_comment' ) );
		?>
	</ol>
