...
function angle_customizer_define_typography_sections( $sections ) {
    ...
    $typography_sections['font-site-title'] = array(
        ...
        'options' => array(
            'font-family-site-title'   => array(
                'setting' => array(
                    'sanitize_callback' => 'angle_sanitize_font_choice',
                ),
                'control' => array(
                    'label'   => __( 'Site Title Font Family', 'wpzoom' ),
                    'type'    => 'select',
                    'choices' => angle_all_font_choices()
                ),
            ),
...
add_filter( 'zoom_customizer_sections', 'angle_customizer_define_typography_sections' );
