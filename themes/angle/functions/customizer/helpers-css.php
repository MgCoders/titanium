...
if ( ! class_exists( 'angle_CSS' ) ) :
    ...
    class angle_CSS {
        ...
        /**
         * The one instance of angle_CSS.
         *
         * @var   angle_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one angle_CSS instance.
         *
         * @return angle_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'angle_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `angle_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'angle_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'angle_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'angle_get_css' ) ) :
    /**
     * Return the one angle_CSS object.
     *
     * @return angle_CSS    The one angle_CSS object.
     */
    function angle_get_css() {
        return angle_CSS::instance();
    }
endif;

add_action( 'init', 'angle_get_css', 1 );